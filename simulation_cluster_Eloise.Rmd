...
plot_taille <- ggplot(resultats_combines, aes(x = as.factor(taux_cluster), y = taille_echantillon, fill = groupe)) +
  geom_boxplot(position = position_dodge(0.8), color = "black") +
  labs(title = "Boxplot de la taille de l'échantillon par taux_cluster",
       x = "Taux Cluster",
       y = "Taille de l'échantillon") +
...
plot_malades <- ggplot(resultats_combines, aes(x = as.factor(taux_cluster), y = nombre_malades, fill = groupe)) +
  geom_boxplot(position = position_dodge(0.8), color = "black") +
  labs(title = "Boxplot du nombre de malades par taux_cluster",
       x = "Taux Cluster",
       y = "Nombre de malades") +
